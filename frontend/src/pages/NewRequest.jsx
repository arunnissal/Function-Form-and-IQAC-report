          ...
          {step === 7 && (
            <div style={{textAlign: 'center', padding: '2rem'}}>
              ...
              <p style={{color: 'var(--text-secondary)', marginBottom: '2rem'}}>
                You have filled out all sections. Click the button below to review your details and officially submit this request to your HOD.
              </p>
      ...
      {showConfirmModal && (
        <div style={{position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000}}>
          <div style={{background: 'white', padding: '2rem', borderRadius: '8px', width: '500px', maxWidth: '90%', textAlign: 'left'}}>
            <h3 style={{color: 'var(--primary-color)', marginBottom: '1rem'}}>Confirm Submission</h3>
            <div style={{background: '#fef3c7', color: '#92400e', padding: '1rem', borderRadius: '6px', marginBottom: '1.5rem', fontSize: '0.875rem', lineHeight: '1.5'}}>
              ...
              <ul style={{margin: '0.5rem 0 0 1.5rem', padding: 0}}>
                <li>I declare that the details provided above are true and accurate.</li>
                <li>I understand that once submitted, <strong>no further changes can be made</strong> to this request.</li>
                <li>Any additional resources must be requested separately or approved directly by the HOD.</li>
              </ul>
            </div>
